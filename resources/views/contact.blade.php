        ...
        <div class="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-8 grid gap-4 md:grid-cols-2">
                    ...
                    <div class="rounded-[1.5rem] bg-slate-50 p-5 dark:bg-slate-800">
                        <p class="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">What to use this for</p>
                        <p class="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">Account issues, billing help, feature requests, and questions about how scan credits or reports work.</p>
                    </div>
                </div>
            </div>
        </div>
