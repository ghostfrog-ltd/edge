<footer class="border-t border-slate-200 bg-white/90 dark:border-slate-800 dark:bg-slate-900/90">
    <div class="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-6 text-sm text-slate-500 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8 dark:text-slate-400">
        <div>
            <p class="font-semibold text-slate-700 dark:text-slate-100">Fuzzynode Ebay Edge</p>
            <p class="mt-1">Market intelligence for eBay sellers, brought to life by Fuzzynode.</p>
        </div>
